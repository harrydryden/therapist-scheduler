...
const adminPages: AdminCard[] = [
  ...
  },
  {
    ...
    preview: 'Edit bios, categories, availability, and active status. Force-unfreeze when needed.',
  },
  {
    name: 'Vouchers',
    path: '/admin/vouchers',
  ...
  },
  {
    ...
    preview: 'Upload therapist CVs to extract their profile, availability, and contact info into the database.',
  },
  {
    name: 'Knowledge Base',
