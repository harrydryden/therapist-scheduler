...
const adminPages: AdminCard[] = [
  ...
  },
  {
    ...
    preview: 'View daily reports of agent activity including messages sent, appointments booked, alerts raised, and pipeline status. Reports generated every weekday at 9am.',
    color: 'bg-teal-500',
  },
  {
    name: 'Settings',
